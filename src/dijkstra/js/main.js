...
$('#setexample').on('change', function () {
    ...
    if (value == 1) {
        ...
        maps.setView(new L.LatLng(11.0849, 122.4809), 18);

        // $.getJSON("dijkstra/mapdata/nodesandpaths1.json", function (datad) {
        ...
        $.ajax({
            url: "distribution_latlong.php",
            type: "GET",
            dataType: "JSON",
            success: function(d){

                $.map(d, function(elem){
                        mapdata.allnodes = d.nodes;
                        mapdata.paths = d.paths;
                        mapdata.distances = [];
                        mapdata.getstate.selectedNode = null;
                        mapdata.getstate.fromNode = null;
                        mapdata.getstate.toNode = null;
